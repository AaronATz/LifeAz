import { ElementRef, Renderer2, EventEmitter, NgZone, OnChanges, AfterViewInit, OnDestroy } from '@angular/core';
/**
...
export declare class EllipsisDirective implements OnChanges, OnDestroy, AfterViewInit {
     ...
     */
    resizeDetectionStrategy: '' | 'element-resize-detector' | 'element-resize-detector-object' | 'window';
    /**
     ...
     */
    moreClickEmitter: EventEmitter<any>;
    /**
